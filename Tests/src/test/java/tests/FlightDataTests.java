...
public class FlightDataTests extends BaseTest {
    ...
    @Test(testName = "AS-0 Check that the input field works correctly")
    ...
    @Test(testName = "AS-1 Check that the entered data is displayed correctly")
    ...
    @Test(testName = "AS-2 Check that the entered data is displayed correctly")
    ...
    @Test(testName = "AS-3 Check that the entered data is displayed correctly")
